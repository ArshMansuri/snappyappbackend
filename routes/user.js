...
const { signin, login, followAndUnFollow, logout, updatePassWord, updateProfile, ownerProfile, ownerFollowers, ownerFollowings, friendProfile, loadUser, searchUser, friFollowers, friFollowings, suggestionUsers, avatarUpdate, userNameAvailable, msgUsers } = require('../controller/user');
...
router.route('/available/username').post(isAuthor, userNameAvailable);
